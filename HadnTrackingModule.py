...
class HandDetector():
    def __init__(self, mode=False, maxHands=2,complexity =1, minDetectionConf=0.5, trackConf=0.5,max_num_hands =2):
        self.mode = mode
...
def main():
    ...
    detector = HandDetector(minDetectionConf=0.5, maxHands=2)
